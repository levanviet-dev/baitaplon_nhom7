...
<head>
    ...
    <!-- //for-mobile-apps -->
    <link href="{{url('public/sites')}}/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
    <link href="{{url('public/sites')}}/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="{{url('public/sites')}}/css/chocolat.css" type="text/css" media="screen">
    <link href="{{url('public/sites')}}/css/easy-responsive-tabs.css" rel='stylesheet' type='text/css' />
    <link rel="stylesheet" href="{{url('public/sites')}}/css/flexslider.css" type="text/css" media="screen" property="" />
    <link rel="stylesheet" href="{{url('public/sites')}}/css/jquery-ui.css" />
    <link href="{{url('public/sites')}}/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <script type="text/javascript" src="{{url('public/sites')}}/js/modernizr-2.6.2.min.js"></script>
    <!--fonts-->
...
<body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="{{url('public/sites')}}/images/1.jpg" alt=" " class="img-responsive">
        ...
        <div class="container">
            ...
            <div id="horizontalTab">
                <ul class="resp-tabs-list">
                    <li>
                        <img src="{{url('public/sites')}}/images/teams1.jpg" alt=" " class="img-responsive" />
                    </li>
                    <li>
                        <img src="{{url('public/sites')}}/images/teams2.jpg" alt=" " class="img-responsive" />
                    </li>
                    <li>
                        <img src="{{url('public/sites')}}/images/teams3.jpg" alt=" " class="img-responsive" />
                    </li>
                    <li>
                        <img src="{{url('public/sites')}}/images/teams4.jpg" alt=" " class="img-responsive" />
                    </li>
                </ul>
    ...
    <section class="portfolio-w3ls" id="gallery">
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g2.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g2.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g3.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g3.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g4.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g4.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g5.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g5.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g6.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g6.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g6.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g7.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g6.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g8.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g9.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g9.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/g10.jpg" class="swipebox"><img src="{{url('public/sites')}}/images/g10.jpg" class="img-responsive" alt="/">
                <div class="textbox">
                    <h4>SUN RISE</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
             ...
             <div class="col-md-3 price-grid">
                    <div class="price-block agile">
                        <div class="price-gd-top">
                            <img src="{{url('public/sites')}}/images/r1.jpg" alt=" " class="img-responsive" />
                            <h4>Phòng Vip</h4>
                        </div>
                    ...
                    <ul class="slides">
                        <li>
                            <div class="w3layouts_work_grid_left">
                                <img src="{{url('public/sites')}}/images/5.jpg" alt=" " class="img-responsive" />
                                <div class="w3layouts_work_grid_left_pos">
                                    <img src="{{url('public/sites')}}/images/c1.jpg" alt=" " class="img-responsive" />
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="w3layouts_work_grid_left">
                                <img src="{{url('public/sites')}}/images/5.jpg" alt=" " class="img-responsive" />
                                <div class="w3layouts_work_grid_left_pos">
                                    <img src="{{url('public/sites')}}/images/c2.jpg" alt=" " class="img-responsive" />
                                </div>
                            </div>
                            <div class="w3layouts_work_grid_right">
                                <h4>
                        ...
                        <li>
                            <div class="w3layouts_work_grid_left">
                                <img src="{{url('public/sites')}}/images/5.jpg" alt=" " class="img-responsive" />
                                <div class="w3layouts_work_grid_left_pos">
                                    <img src="{{url('public/sites')}}/images/c3.jpg" alt=" " class="img-responsive" />
                                </div>
                            </div>
                            <div class="w3layouts_work_grid_right">
                                <h4>
                        ...
                        <li>
                            <div class="w3layouts_work_grid_left">
                                <img src="{{url('public/sites')}}/images/5.jpg" alt=" " class="img-responsive" />
                                <div class="w3layouts_work_grid_left_pos">
                                    <img src="{{url('public/sites')}}/images/c4.jpg" alt=" " class="img-responsive" />
                                </div>
                            </div>
                            <div class="w3layouts_work_grid_right">
                                <h4>
    ...
    <!--/footer -->
    <!-- js -->
    <script type="text/javascript" src="{{url('public/sites')}}/js/jquery-2.1.4.min.js"></script>
    <!-- contact form -->
    <script src="{{url('public/sites')}}/js/jqBootstrapValidation.js"></script>

    <!-- /contact form -->
    <!-- Calendar -->
    <script src="{{url('public/sites')}}/js/jquery-ui.js"></script>
    <script>
        $(function() {
    ...
    <!-- //Calendar -->
    <!-- gallery popup -->
    <link rel="stylesheet" href="{{url('public/sites')}}/css/swipebox.css">
    <script src="{{url('public/sites')}}/js/jquery.swipebox.min.js"></script>
    ...
    <script type="text/javascript" src="{{url('public/sites')}}/js/move-top.js"></script>
    <script type="text/javascript" src="{{url('public/sites')}}/js/easing.js"></script>
    <script type="text/javascript">
    ...
    <!-- start-smoth-scrolling -->
    <!-- flexSlider -->
    <script defer src="{{url('public/sites')}}/js/jquery.flexslider.js"></script>
    <script type="text/javascript">
    ...
    <!-- //flexSlider -->
    <script src="{{url('public/sites')}}/js/responsiveslides.min.js"></script>
    <script>
    ...
    <!--search-bar-->
    <script src="{{url('public/sites')}}/js/main.js"></script>
    <!--//search-bar-->
    <!--tabs-->
    <script src="{{url('public/sites')}}/js/easy-responsive-tabs.js"></script>
    <script>
    ...
    <!-- //smooth scrolling -->
    <script type="text/javascript" src="{{url('public/sites')}}/js/bootstrap-3.1.1.min.js"></script>
</body>
